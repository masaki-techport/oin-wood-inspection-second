...
CREATE TABLE t_inspection_details (
  ...
  x_position        FLOAT NOT NULL COMMENT 'X1座標 (左上X)',
  y_position        FLOAT NOT NULL COMMENT 'Y1座標 (左上Y)',
  x2_position       FLOAT DEFAULT NULL COMMENT 'X2座標 (右下X)',
  y2_position       FLOAT DEFAULT NULL COMMENT 'Y2座標 (右下Y)',
  width             FLOAT NOT NULL COMMENT '幅 (x2_position - x_position)',
  height            FLOAT NOT NULL COMMENT '高さ (y2_position - y_position)',
