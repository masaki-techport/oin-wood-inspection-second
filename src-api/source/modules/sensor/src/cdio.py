...
# ----------------------------------------
PDIO_INT_CALLBACK = ctypes.WINFUNCTYPE(
    None, ctypes.c_short, ctypes.wintypes.WPARAM, ctypes.wintypes.LPARAM, ctypes.c_void_p
)
PDIO_TRG_CALLBACK = ctypes.WINFUNCTYPE(
    None, ctypes.c_short, ctypes.wintypes.WPARAM, ctypes.wintypes.LPARAM, ctypes.c_void_p
)
PDIO_DM_COUNT_CALLBACK = ctypes.WINFUNCTYPE(
    None, ctypes.c_short, ctypes.wintypes.WPARAM, ctypes.wintypes.LPARAM, ctypes.c_void_p
)
PDIO_DM_STOP_CALLBACK = ctypes.WINFUNCTYPE(
    None, ctypes.c_short, ctypes.wintypes.WPARAM, ctypes.wintypes.LPARAM, ctypes.c_void_p
)
...
DioGetNetCommunicationInfo.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
...
# C Prototype: long WINAPI DioInpByteSR(short Id, short PortNo, unsigned char *Data,
#                                      unsigned short *Timestamp, BYTE Mode);
DioInpByteSR = cdio_dll.DioInpByteSR
DioInpByteSR.restype = ctypes.c_long
DioInpByteSR.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
...
# C Prototype: long WINAPI DioInpBitSR(
#     short Id, short BitNo, unsigned char *Data,
#     unsigned short *Timestamp, BYTE Mode
# );
DioInpBitSR = cdio_dll.DioInpBitSR
DioInpBitSR.restype = ctypes.c_long
DioInpBitSR.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ubyte),
    ctypes.POINTER(ctypes.c_ushort),
...
# C Prototype: long WINAPI DioInpMultiByteSR(
#     short Id, short *PortNo, short PortNum, unsigned char *Data,
#     unsigned short *Timestamp, unsigned char Mode
# );
DioInpMultiByteSR = cdio_dll.DioInpMultiByteSR
DioInpMultiByteSR.restype = ctypes.c_long
DioInpMultiByteSR.argtypes = [
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_short),
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ubyte),
...
# C Prototype: long WINAPI DioInpMultiBitSR(
#     short Id, short *BitNo, short BitNum, unsigned char *Data,
#     unsigned short *Timestamp, unsigned char Mode
# );
DioInpMultiBitSR = cdio_dll.DioInpMultiBitSR
DioInpMultiBitSR.restype = ctypes.c_long
DioInpMultiBitSR.argtypes = [
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_short),
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ubyte),
...
# C Prototype: long WINAPI DioEchoBackMultiByte(short Id, short *PortNo, short PortNum,
#                                               BYTE *Data);
DioEchoBackMultiByte = cdio_dll.DioEchoBackMultiByte
DioEchoBackMultiByte.restype = ctypes.c_long
DioEchoBackMultiByte.argtypes = [
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_short),
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ubyte),
...
# C Prototype: long WINAPI DioSetInterruptCallBackProc(
#     short Id, PDIO_INT_CALLBACK CallBackProc, void *Param
# );
...
# Trigger function
# ----------------------------------------
# C Prototype: long WINAPI DioNotifyTrg(
#     short Id, short TrgBit, short TrgKind, long Tim, HANDLE hWnd
# );
DioNotifyTrg = cdio_dll.DioNotifyTrg
DioNotifyTrg.restype = ctypes.c_long
DioNotifyTrg.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
    ctypes.c_short,
    ctypes.c_long,
...
# C Prototype: long WINAPI DioSetTrgCallBackProc(
#     short Id, PDIO_TRG_CALLBACK CallBackProc, void *Param
# );
...
# ----------------------------------------
# C Prototype: long WINAPI DioGetDeviceInfo(
#     char *Device, short InfoType, void *Param1, void *Param2, void *Param3
# );
DioGetDeviceInfo = cdio_dll.DioGetDeviceInfo
DioGetDeviceInfo.restype = ctypes.c_long
DioGetDeviceInfo.argtypes = [
    ctypes.c_char_p,
    ctypes.c_short,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
# C Prototype: long WINAPI DioSetCountMatchValue(
#     short Id, short *ChNo, short ChNum, short *CompareRegNo, unsigned long *CompareCount
# );
DioSetCountMatchValue = cdio_dll.DioSetCountMatchValue
DioSetCountMatchValue.restype = ctypes.c_long
DioSetCountMatchValue.argtypes = [
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_short),
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_short),
...
# C Prototype: long WINAPI DioGetCountStatus(
#     short Id, short *ChNo, short ChNum, unsigned long *CountStatus
# );
DioGetCountStatus = cdio_dll.DioGetCountStatus
DioGetCountStatus.restype = ctypes.c_long
DioGetCountStatus.argtypes = [
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_short),
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ulong),
...
# C Prototype: long WINAPI DioCountPreset(
#     short Id, short *ChNo, short ChNum, unsigned long *PresetCount
# );
DioCountPreset = cdio_dll.DioCountPreset
DioCountPreset.restype = ctypes.c_long
DioCountPreset.argtypes = [
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_short),
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ulong),
...
# C Prototype: long WINAPI DioReadCountSR(
#     short Id, short *ChNo, short ChNum, unsigned long *Count,
#     unsigned short * Timestamp, BYTE Mode
# );
DioReadCountSR = cdio_dll.DioReadCountSR
DioReadCountSR.restype = ctypes.c_long
DioReadCountSR.argtypes = [
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_short),
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ulong),
...
# C Prototype: long WINAPI DioDmSetMaster(
#     short Id, short ExtSig1, short ExtSig2, short ExtSig3,
#     short MasterHalt, short SlaveHalt
# );
DioDmSetMaster = cdio_dll.DioDmSetMaster
DioDmSetMaster.restype = ctypes.c_long
DioDmSetMaster.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
    ctypes.c_short,
    ctypes.c_short,
...
# C Prototype: long WINAPI DioDmSetStartPattern(short Id, unsigned long Pattern,
#                                               unsigned long Mask);
...
# C Prototype: long WINAPI DioDmSetInternalClock(short Id, short Direction,
#                                                unsigned long Clock, short Unit);
...
# C Prototype: long WINAPI DioDmSetBuffer(
#     short Id, short Direction, unsigned long *Buffer, unsigned long Length, short IsRing
# );
DioDmSetBuffer = cdio_dll.DioDmSetBuffer
DioDmSetBuffer.restype = ctypes.c_long
DioDmSetBuffer.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ulong),
    ctypes.c_ulong,
...
# C Prototype: long WINAPI DioDmGetStatus(
#     short Id, short Direction, unsigned long *Status, unsigned long *Err
# );
DioDmGetStatus = cdio_dll.DioDmGetStatus
DioDmGetStatus.restype = ctypes.c_long
DioDmGetStatus.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ulong),
    ctypes.POINTER(ctypes.c_ulong),
...
# C Prototype: long WINAPI DioDmGetCount(
#     short Id, short Direction, unsigned long *Count, unsigned long *Carry
# );
DioDmGetCount = cdio_dll.DioDmGetCount
DioDmGetCount.restype = ctypes.c_long
DioDmGetCount.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ulong),
    ctypes.POINTER(ctypes.c_ulong),
...
# C Prototype: long WINAPI DioDmGetWritePointer(
#     short Id, short Direction, unsigned long *WritePointer,
#     unsigned long *Count, unsigned long *Carry
# );
DioDmGetWritePointer = cdio_dll.DioDmGetWritePointer
DioDmGetWritePointer.restype = ctypes.c_long
DioDmGetWritePointer.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
    ctypes.POINTER(ctypes.c_ulong),
    ctypes.POINTER(ctypes.c_ulong),
...
# C Prototype: long WINAPI DioDmSetStopCallBackProc(
#     short Id, PDIO_DM_STOP_CALLBACK CallBackProc, void *Param
# );
...
# C Prototype: long WINAPI DioDmSetCountEvent(short Id, short Direction, unsigned long Count,
#                                             HANDLE hWnd);
DioDmSetCountEvent = cdio_dll.DioDmSetCountEvent
DioDmSetCountEvent.restype = ctypes.c_long
DioDmSetCountEvent.argtypes = [
    ctypes.c_short,
    ctypes.c_short,
    ctypes.c_ulong,
    ctypes.wintypes.HANDLE,
...
# C Prototype: long WINAPI DioDmSetCountCallBackProc(
#     short Id, PDIO_DM_COUNT_CALLBACK CallBackProc, void *Param
# );
...
DIO_ERR_SYS_RECOVERED_FROM_STANDBY = (
    7  # Execute DioResetDevice function because the device has recovered from
    # standby mode.
)
DIO_ERR_INI_NOT_FOUND_SYS_FILE = (
    8  # Because the Cdio.sys file is not found, it is not possible to
    # initialize it.
)
DIO_ERR_INI_DLL_FILE_VERSION = 9  # Because version information on the Cdio.dll file cannot be
# acquired, it is not possible to initialize it.
DIO_ERR_INI_SYS_FILE_VERSION = 10  # Because version information on the Cdio.sys file cannot be
# acquired, it is not possible to initialize it.
DIO_ERR_INI_NO_MATCH_DRV_VERSION = 11  # Because version information on Cdio.dll and
# Cdio.sys is different, it is not possible to initialize it.
# ----------------------------------------
# DLL Error
# ----------------------------------------
...
STATUS_SYS_USB_BTSTUFF = (
    20021  # the last data packet received from end point exist bit stuffing offense error
)
STATUS_SYS_USB_DATA_TOGGLE_MISMATCH = (
    20022  # the last data packet received from end point exist toggle packet mismatch error
)
STATUS_SYS_USB_STALL_PID = 20023  # end point return STALL packet identifier
STATUS_SYS_USB_DEV_NOT_RESPONDING = (
    20024  # device don't respond to token(IN) ,don't support handshake
)
